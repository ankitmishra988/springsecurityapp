...
//	   http.httpBasic().and()
//	  .authorizeRequests().antMatchers("/api/**").hasAnyRole("ROLE_USER","ROLE_ADMIN").and()
//	  .formLogin();
	   
//		authorizeHttpRequests().antMatchers("/secure/**").authenticated().anyRequest().hasRole("ADMIN").and().
//		formLogin().permitAll();
	}
